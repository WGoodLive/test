...
use crate::{sync::mutex::{Mutex, MutexBlocking, MutexSpin}, task::block_current_and_run_next, timer::{add_timer, get_time_ms}};

use super::{current_process, current_task, process};
...
pub fn sys_mutex_create(blocking: bool) -> isize{
    ...
    let mutex:Option<Arc<dyn Mutex>> = if !blocking{ // 有两种结构体都满足，类似多态
